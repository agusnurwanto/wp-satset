...
function import_excel_aids(){
    var tahun_anggaran = jQuery('#data-tahun-aids').val();
    if (!tahun_anggaran.match(/^\d{4}$/)) {
        return alert('Tahun anggaran tidak valid!');
    }
    var data = jQuery('#data-excel').val();
    if(!data){
        ...
        .then(function(data_last){
            jQuery('#wrap-loading').hide();
            alert('Success import data AIDS dari excel!');
        })
        .catch(function(e){
            console.log(e);
            jQuery('#wrap-loading').hide();
...
function import_excel_malaria(){
    var tahun_anggaran = jQuery('#data-tahun-malaria').val();
    if (!tahun_anggaran.match(/^\d{4}$/)) {
        return alert('Tahun anggaran tidak valid!');
    }
    var data = jQuery('#data-excel').val();
    if(!data){
        ...
        .then(function(data_last){
            jQuery('#wrap-loading').hide();
            alert('Success import data Malaria dari excel!');
        })
        .catch(function(e){
            console.log(e);
            jQuery('#wrap-loading').hide();
...
function get_data_ats() {
    ...
    .then(function() {
        hide_loading();
        alert('Sinkronisasi ATS selesai!');
    })
    .catch(function(err) {
        console.error(err);
        hide_loading();
