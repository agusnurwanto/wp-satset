...
class Wp_Satset {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action('wp_ajax_import_excel_malaria',  $plugin_admin, 'import_excel_malaria');
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action('wp_ajax_get_datatable_malaria',    $plugin_public, 'get_datatable_malaria');
		$this->loader->add_action('wp_ajax_hapus_data_malaria_by_id', $plugin_public, 'hapus_data_malaria_by_id');
		$this->loader->add_action('wp_ajax_get_data_malaria_by_id',   $plugin_public, 'get_data_malaria_by_id');
		$this->loader->add_action('wp_ajax_tambah_data_malaria',      $plugin_public, 'tambah_data_malaria');
		$this->loader->add_action('wp_ajax_mapping_kode_desa_malaria',$plugin_public, 'mapping_kode_desa_malaria');
		...
		add_shortcode('management_data_malaria_satset', array($plugin_public, 'management_data_malaria_satset'));
		...
		add_shortcode('data_malaria', array($plugin_public, 'data_malaria'));
		add_shortcode('data_detail_malaria', array($plugin_public, 'data_detail_malaria'));
		...
		add_shortcode('data_detail_aids', array($plugin_public, 'data_detail_aids'));
		...
		add_shortcode('mapping_desa_malaria', array($plugin_public, 'mapping_desa_malaria'));
	}
