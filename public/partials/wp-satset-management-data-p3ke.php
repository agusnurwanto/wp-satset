...
<div class="cetak">
	...
	<h1 class="text-center" style="margin:3rem;">Manajemen Data P3KE</h1>
		<div style="margin-bottom: 25px;">
			<button class="btn btn-primary" onclick="tambah_data();"><i class="dashicons dashicons-plus"></i> Tambah Data P3KE</button>
		</div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for='tambah_nik' style='display:inline-block'>NIK</label>
                    <input type='text' id='tambah_nik' name="tambah_nik" class="form-control" placeholder=''>
                </div>
                <div class="form-group">
    ...
    jQuery.ajax({
        ...
        success: function(res){
            if(res.status == 'success'){
                ...
                jQuery('#tambah_nik').val(res.data.nik);
...
function submitTambahDataFormP3KE(){
    ...
    var tambah_nik = jQuery('#tambah_nik').val();
    if(tambah_nik == ''){
        return alert('Data tambah_nik tidak boleh kosong!');
    }
    var tambah_padan_dukcapil = jQuery('#tambah_padan_dukcapil').val();
    if(tambah_padan_dukcapil == ''){
        return alert('Data tambah_padan_dukcapil tidak boleh kosong!');
    }
